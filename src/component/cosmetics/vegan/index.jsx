...
import { VeganGet } from '../../../redux/cosmetics/vegan';
...
const VeganCosmetics = () => {
  ...
  const vegan = useSelector((state) => state.vegan.veganGet);
  const veganData = vegan?.data?.filter((_, index) => index !== 1 && index !== 3).slice(0, expanded ? 8 : 3);
